<template>
    <div class="flex flex-col flex-1 items-center">
        ...
        <p>Actuellement, vous regardez la ville. Pour commencer à la suivre, cliquez sur l'icône "+".</p>
        </div>
        <!-- Weather Overview-->
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                <h2 class="mb-4">Température par heure</h2>
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                <h2 class="mb-4">Panorama hebdomadaire</h2>
          ...
          <div class="flex gap-2 flex-1 justify-end">
            <p>Temp. Haute: {{ Math.round(day.temp.max) }}</p>
            <p>Basse: {{ Math.round(day.temp.min) }}</p>
          </div>
        </div>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2 py-12 text-white cursor-pointer duration-150 hover:text-red-500">
            <i class="fa-solid fa-trash" @click="removeCity"></i>
